...
class RequestUtil{
  ...
  Future<http.Response> register_Accomodation(Apartmentname,Ownername,contact1,contact2,address,email,total_accomodation,state,city,locality,tenant,qrid)async{
  ...
  Future<http.Response> register_room(
      accid, roomid, wash_status, status, accomotation_type,
      rent_price, category, rate, tenant, security_deposit,perks) async {
    return http.post(
